...
parser.add_argument('--method', type=str, default='BGSR')
...
parser.add_argument("--img_size", type=int, default=64, help="number of epochs")
parser.add_argument('--LR_size', type=int, default=32, help='number of  blocks')
parser.add_argument('--alpha', type=float, default=0.1, help='hybrid loss coefficient')

# Test image
parser.add_argument('--model_name', default='./checkpoint/Chikusei_model_8_epoch_1.pth', type=str, help='super resolution model name ')
